% This demo code runs for stanford site. 
 
rng(1,'twister') % for reproducibility

%  % stanford %
  A= load('C:\ABIDE\preprocessed\combined_rm_stanford_mat.csv');% 181 control, 332 total
  A1= A(:,1:3486);
  groupsall= A(:,3487);
  k=10;
 
 E= load('C:\ABIDE\preprocessed\stanford_mat.csv');% 20 control, 40 total
  E1= E(:,1:3486);
